...
We, the authors of the `survtmle` R package, use the same guide as is used for
...
The goal of this guide is to help you get up and contributing to `survtmle` as
...
1.  __Motivation__. Your pull request should clearly and concisely motivates the
   ...
   `survtmle` comes out it's easy for users to see what's changed. Add your
