...
#' @param bounds A \code{data.frame} of bounds on the conditional hazard function (if \code{method = "hazard"}) or
...
#' @param tol The stopping criteria when \code{method="hazard"}. The TMLE algorithm performs
