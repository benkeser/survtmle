...
#' data, so please note THAT THIS IS NOT THE REAL RTSS,S DATA. The data set is
#' a \code{list} of 10 simulated multiple outputation draws. The covariate
#' data, \code{ftime}, and \code{vaccine} stay the same across the data sets;
#' however, the \code{ftype} variable changes, simulating output data sets of
#' multiply infected trial participants.
#'
...
#'   \item{startMonthCat}{study site-specific indicator of rainy (=1) versus
#'     dry (=0) season}
#'   ...
#' }
"rtss"
